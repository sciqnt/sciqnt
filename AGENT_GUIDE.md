...
| `sq_secrets` / `sq_config` / `sq_tui` / `sq_platform` | substrate the bundles use (credentials, user config, terminal UI, dispatcher). You generally don't call these directly. |
